<script>
    ...
    //     git: 'https://github.com/brentbrinkley',
    //     linkedIn: 'https://www.linkedin.com/in/brent-brinkley-21932435/',
    //     insta: 'https://www.instagram.com/i_am_echelon/'
    // }
...
<a class="link" href={socLink}>
    <svg
        class="h-6 fill-current text-gray-500 hover:text-yellow-400"
        role="img"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        ><title>{title}</title><path d={vector} /></svg
    >
</a>
<!-- <a class="link" href={git}
        ><svg
            class="h-6 fill-current text-gray-500 hover:text-yellow-400"
            role="img"
            viewBox="0 0 24 24"
