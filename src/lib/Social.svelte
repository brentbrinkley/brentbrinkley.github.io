<script>
    let twitter = 'https://twitter.com/EchelonIsBack'
    let git = 'https://github.com/brentbrinkley'
    let linkedIn = 'https://www.linkedin.com/in/brent-brinkley-21932435/'
    let insta = 'https://www.instagram.com/i_am_echelon/'
</script>
...
>
    ...
    <a class="link" href={linkedIn} data-tippy-content="@linkein_handle">
        <svg
            ...
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
            ><title>LinkedIn icon</title><path
