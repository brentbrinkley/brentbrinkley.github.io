<script>
  let name = 'Brent Brinkley'
  let title = 'Software Engineer'
  let location = 'RDU - RVA'
  let bio = `I'm an engineer, designer, and founder specializing in native iOS and Web Development. Apple Entreprenuer Camp Alum. Founder of Polyhedra, creator of Form music language, and the Formkey App`
</script>

<div>
  <h1 class="text-3xl font-bold pt-8 lg:pt-0">{name}</h1>
  <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-yellow-400 " />
  <p
    class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"
  >
    <svg
      class="h-4 fill-current text-yellow-400 pr-4"
  ...
  <p class="pt-8 text-sm text-left">
    I'm an engineer & designer specializing in native iOS and Web experiences.
    I'm the founder of Polyhedra. The creator of <a
    ...
    <a href="https://formkey.app/" class="text-yellow-500">Formkey</a>
